...
const FACTION_ICONS = {
  ...
  legion:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3.4 3.4c0 4.6 3.6 8 8.6 8s8.6-3.4 8.6-8" fill="none" stroke="currentColor" stroke-width="2.6" stroke-linecap="round"/><path fill-rule="evenodd" d="M12 9.4a6.2 6.2 0 1 0 0 12.4 6.2 6.2 0 0 0 0-12.4Zm-2.3 4.9a1.05 1.05 0 1 0 0 2.1 1.05 1.05 0 0 0 0-2.1Zm4.6 0a1.05 1.05 0 1 0 0 2.1 1.05 1.05 0 0 0 0-2.1Zm-3.1 3.9h3.6v1.5h-3.6z"/></svg>',
  followers:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2.4v19.2" fill="none" stroke="currentColor" stroke-width="2.1" stroke-linecap="round"/><path d="M12 18.8c-3.6 0-3.6-3.9 0-3.9s3.6-3.9 0-3.9-3.6-3.9 0-3.9 3.6-3.9 0-3.9" fill="none" stroke="currentColor" stroke-width="2.1" stroke-linecap="round"/><path d="M12 3.4c1.7 0 3-.9 3.5-2.3.4 1.2-.2 2.4-1.3 3.1l2.1.6-2.8.9z"/></svg>',
