...
/* Original, in-house SVG glyph per faction (flat single-colour silhouettes, fill:currentColor so they
   ...
   Brotherhood=gear+sword · Vault=vault door + handle wheel · Legion=the Bull · Bazaar=market awning ·
   Tribe=campfire · Enclave=eagle · Unity=DNA helix · NCR=bear paw. Shown in the faction picker + home. */
const FACTION_ICONS = {
  ...
  bazaar:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 3.5h18v3H3z"/><path d="M3 6.5h18l-1.8 2.2-1.8-2.2-1.8 2.2-1.8-2.2-1.8 2.2-1.8-2.2-1.8 2.2-1.8-2.2-1.8 2.2L3 6.5Z"/><path d="M4.3 6.5h1.5v13H4.3zM18.2 6.5h1.5v13h-1.5z"/></svg>',
