...
const FACTIONS = {
  ...
  townsfolk:   { name:"Townsfolk",                   brand:"TOWNSFOLK",               tagline:"// TOWN-NET",     theme:{color:"white",   bg:"slate"},    font:{head:"plex",      body:"plex"},      data:{sheetId:"", gid:""}, docs:[] },
...
/* Original, in-house SVG glyph per faction (flat single-colour silhouettes, fill:currentColor so they
   ...
   NCR=bear paw · Unity=DNA helix · Followers=medical cross · Townsfolk=house · Wastelanders=compass ·
   Outlaws=skull · Synthetics=robot head · Super Mutants=fist. Shown in the faction picker + home. */
const FACTION_ICONS = {
  ...
  townsfolk:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2.4 2.2 10.6h2.4V21h5V15h4.8v6h5V10.6h2.4z"/></svg>',
