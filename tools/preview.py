...
It:
  ...
  2. (re)creates /tmp/yuma-live and copies index.html / styles.css / app.js + fonts/ media/ c/
  3. prints the URL to open — with ?sheet=<public mirror> so the SOURCE app.js is never edited

Then start/refresh the "yuma-roster" preview server. No sheet-id sed, ever (that footgun is
...
# Isolated static server for the Yuma Roster preview (auto-generated by tools/preview.py).
